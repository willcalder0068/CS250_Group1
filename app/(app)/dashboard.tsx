  ...
  return (
    <View style={styles.headerContainer}>
      <View style={styles.headerTitleContainer}>
        ...
        <Text style={styles.headerSubtitle}>Let's do some laundry!👕🫧⋆｡˚</Text>
      </View>
      <TouchableOpacity onPress={handleLogout} style={styles.logoutButton} hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }} accessibilityLabel="Logout">
...
const styles = StyleSheet.create({
  ...
  // Add these styles to your StyleSheet in DashboardScreen.js
  headerContainer: {
    padding: 20,
    paddingBottom: 10,
    flexDirection: 'row', // Arrange title and button side-by-side
    justifyContent: 'space-between', // Pushes them to opposite ends
    alignItems: 'flex-start', // Align items to the top so the icon lines up with the title
  },
